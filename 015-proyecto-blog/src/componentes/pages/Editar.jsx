...
export const Editar = () => {
	...
	const editarArticulos = async(e) => {
		...
		let {datos,cargando} = await Peticion(Global.url+"articulo/"+params.id,"PUT",nuevoArticulo);
	...
	return (
		<div className="jumbo">
			...
			<strong>{resultado == "si" ? "Articulo actualizado" : resultado}</strong>
